...
CANONICAL_METRICS: list[dict] = [
    {
        ...
        "name": "综合风险得分",
        "description": "五维加权综合得分，衡量主体综合风险水平。",
        "metric_type": "derived",
        "formula": "0.25*tax_health + 0.25*authenticity + 0.20*industry + 0.15*legal + 0.15*finance",
        "unit": "分",
        "grain": "enterprise",
        "source_fields": [],
        "dimensions": ["industry_l1", "province", "scale_label", "time"],
        "default_filters": {},
        "edge_cases": "五维权重见 assessment_weights.DIMENSION_WEIGHTS；法律维度缺事件时按部分覆盖权重 0.05 折算。",
    },
    {
