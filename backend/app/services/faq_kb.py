...
FAQ_ENTRIES: list[dict] = [
    ...
    },
    {
        ...
        "answer": (
            "财务分析先确定企业和时间范围，再看盈利、现金流、资产负债和营运效率四类指标，"
            "随后结合行业或历史基准做对比，最后把指标结论汇总为经营质量与偿债能力判断。"
            "可以直接问：这家资产负债率、现金流质量、毛利率怎么样。"
        ),
    },
    {
        "id": "analysis_tax",
        ...
        "answer": (
            "税务分析先看申报和缴税行为，再检查税负、欠税、违法、信用和更正等信号，"
            "最后与开票、财务数据做交叉验证，区分数据异常、申报偏差和实质税务风险。"
            "可以直接问：税务健康分、增值税税负、欠税记录或税务违法情况。"
        ),
    },
    {
        "id": "analysis_invoice",
        ...
        "answer": (
            "发票分析从开票规模、作废与红冲、客户和供应商集中度、价格异常以及多口径营收偏差入手，"
            "再用票据结构与经营行为相互验证，优先识别可能存在虚假交易或异常资金链路的信号。"
        ),
    },
    {
        "id": "analysis_authenticity",
        "keywords": [
            "真实性怎么分析",
            "怎么分析真实性",
            "收入真实性怎么查",
        ...
        "answer": (
            "真实性分析会比较申报、开票和财务三套口径，并检查收入偏差、客户供应商集中度、"
            "异常票据和经营连续性。结论只说明数据之间的偏离和需要核查的方向，不替代监管或司法认定。"
        ),
    },
]
