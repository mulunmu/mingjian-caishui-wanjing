...
def ensure_metric_definition_v2_columns(engine: Engine) -> None:
    statements = [
        ...
        "ALTER TABLE metric_definition ADD COLUMN IF NOT EXISTS threshold_required BOOLEAN NOT NULL DEFAULT FALSE",
        ...
        "CREATE INDEX IF NOT EXISTS ix_metric_definition_threshold_required ON metric_definition (threshold_required)",
    ]
